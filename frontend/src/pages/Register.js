        ...
        <div className="w-full max-w-md">
          <div className="bg-white border border-gray-200 p-8 rounded-sm shadow-sm">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-gray-900 mb-2" style={{fontFamily: 'Outfit, sans-serif'}} data-testid="register-heading">
                Create Account
              </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6" data-testid="register-form">
              ...
              {error && (
                <div className="bg-red-50 border border-red-200 text-red-700 p-4 rounded-sm text-sm" data-testid="register-error-message">
                  {error}
                </div>
              )}
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 text-center">
              <p className="text-sm text-gray-500">
                ...
                <Link to="/login" className="text-blue-600 hover:text-blue-700 transition-colors duration-150" data-testid="login-link">
                  Login
                </Link>
              </p>
            </div>
