      ...
      <main className="flex-1">
        ...
        <section className="bg-zinc-900 border-b border-zinc-800 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-xs font-mono uppercase tracking-[0.2em] text-blue-500 mb-4">About Us</div>
            <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight text-zinc-50 mb-6" style={{fontFamily: 'Outfit, sans-serif'}} data-testid="about-heading">
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              <div>
                <h2 className="text-2xl sm:text-3xl font-medium tracking-tight text-zinc-50 mb-6" style={{fontFamily: 'Outfit, sans-serif'}}>
                  Our Mission
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-sm" data-testid="value-innovation">
                <Building2 className="w-8 h-8 text-blue-500 mb-4" />
                <h3 className="text-xl font-medium text-zinc-100 mb-3" style={{fontFamily: 'Outfit, sans-serif'}}>Innovation</h3>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  We continuously innovate our assessment platform to provide the most effective and secure testing environment.
                </p>
              </div>

              <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-sm" data-testid="value-excellence">
                <Target className="w-8 h-8 text-blue-500 mb-4" />
                <h3 className="text-xl font-medium text-zinc-100 mb-3" style={{fontFamily: 'Outfit, sans-serif'}}>Excellence</h3>
                <p className="text-sm text-zinc-400 leading-relaxed">
                  Our commitment to excellence ensures that every assessment meets the highest standards of quality and integrity.
                </p>
              </div>

              <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-sm" data-testid="value-community">
                <Heart className="w-8 h-8 text-blue-500 mb-4" />
                <h3 className="text-xl font-medium text-zinc-100 mb-3" style={{fontFamily: 'Outfit, sans-serif'}}>Community</h3>
                <p className="text-sm text-zinc-400 leading-relaxed">
        ...
        <section className="py-16 bg-zinc-900 border-t border-zinc-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-zinc-950 border border-zinc-800 p-6 rounded-sm max-w-2xl mx-auto">
              <p className="text-base text-zinc-300 mb-2"><strong className="text-zinc-100">Address:</strong></p>
              <p className="text-sm text-zinc-400 mb-4">Ground Floor, TechCentral Building<br />Lot Fourteen, Frome Road<br />Adelaide SA 5000</p>
              <p className="text-base text-zinc-300 mb-2"><strong className="text-zinc-100">Phone:</strong></p>
              <p className="text-sm text-zinc-400">+61 8 8155 5320</p>
            </div>
          </div>
        </section>
      </main>
